...
public class ModFoods
{
	...
	public static final Food FOUL_BERRIES = (new Food.Builder()).hunger(2).saturation(0.1F).effect(new EffectInstance(AutumnityEffects.FOUL_TASTE, 1200, 0), 1.0F).build();
}
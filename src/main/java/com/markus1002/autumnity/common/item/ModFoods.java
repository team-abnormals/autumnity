...
public class ModFoods
{
	...
	public static final Food FOUL_BERRIES = (new Food.Builder()).hunger(2).saturation(0.1F).effect(new EffectInstance(ModEffects.FOUL_TASTE, 1200, 0), 1.0F).effect(new EffectInstance(Effects.HUNGER, 600, 0), 0.8F).build();

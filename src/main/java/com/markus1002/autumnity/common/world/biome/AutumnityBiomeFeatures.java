...
public class AutumnityBiomeFeatures
{
	...
	public static void addPumpkinFieldsFeatures(Biome biomeIn)
	{
		...
		biomeIn.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, AutumnityFeatures.LARGE_PUMPKIN.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.COUNT_HEIGHTMAP_DOUBLE.configure(new FrequencyConfig(4))));
	}
}
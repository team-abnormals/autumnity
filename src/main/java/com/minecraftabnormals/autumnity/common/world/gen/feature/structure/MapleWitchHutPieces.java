...
public class MapleWitchHutPieces {
	...
	public static void func_204760_a(TemplateManager p_204760_0_, BlockPos p_204760_1_, Rotation p_204760_2_, List<StructurePiece> p_204760_3_, Random p_204760_4_) {
		p_204760_3_.add(new MapleWitchHutPieces.Piece(p_204760_0_, p_204760_1_, p_204760_2_));
	}
	...
	public static class Piece extends TemplateStructurePiece {
		...
		private void func_204754_a(TemplateManager p_204754_1_) {
			...
			PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE).setCenterOffset(MapleWitchHutPieces.STRUCTURE_OFFSET).addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK);

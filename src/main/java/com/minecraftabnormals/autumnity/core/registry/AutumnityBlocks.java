...
import com.minecraftabnormals.autumnity.common.block.AutumnCrocusBlock;
...
public class AutumnityBlocks
{
	...
	public static final RegistryObject<Block> AUTUMN_CROCUS = HELPER.createBlock("autumn_crocus", () -> new AutumnCrocusBlock(AutumnityEffects.FOUL_TASTE, 320, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.PLANT)), ItemGroup.DECORATIONS);
	...
	public static final RegistryObject<Block> ENDER_JACK_O_LANTERN = HELPER.createCompatBlock("endergetic", "ender_jack_o_lantern", () -> new AutumnityJackOLanternBlock(Block.Properties.from(Blocks.PUMPKIN).setLightLevel((p_235462_0_) -> {
		return 15;
	...
	public static final RegistryObject<Block> SOUL_JACK_O_LANTERN = HELPER.createBlock("soul_jack_o_lantern", () -> new AutumnityJackOLanternBlock(Block.Properties.from(Blocks.PUMPKIN).setLightLevel((p_235462_0_) -> {
		return 15;
	})), ItemGroup.BUILDING_BLOCKS);
	
	public static final RegistryObject<Block> LARGE_JACK_O_LANTERN_SLICE = HELPER.createBlock("large_jack_o_lantern_slice", () -> new CarvedLargePumpkinSliceBlock(Block.Properties.from(Blocks.PUMPKIN).setLightLevel((p_235462_0_) -> {
		return 15;
	})), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> LARGE_SOUL_JACK_O_LANTERN_SLICE = HELPER.createBlock("large_soul_jack_o_lantern_slice", () -> new CarvedLargePumpkinSliceBlock(Block.Properties.from(Blocks.PUMPKIN).setLightLevel((p_235462_0_) -> {
		return 15;
	})), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> LARGE_ENDER_JACK_O_LANTERN_SLICE = HELPER.createCompatBlock("endergetic", "large_ender_jack_o_lantern_slice", () -> new CarvedLargePumpkinSliceBlock(Block.Properties.from(Blocks.PUMPKIN).setLightLevel((p_235462_0_) -> {
		return 15;
	})), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> MAPLE_FENCE = HELPER.createBlock("maple_fence", () -> new WoodFenceBlock(AutumnityProperties.MAPLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> MAPLE_FENCE_GATE = HELPER.createBlock("maple_fence_gate", () -> new WoodFenceGateBlock(AutumnityProperties.MAPLE), ItemGroup.REDSTONE);
	...
	public static final RegistryObject<Block> SLIME = HELPER.createBlockNoItem("slime", () -> new PlaceableSlimeBlock(Block.Properties.create(Material.MISCELLANEOUS, MaterialColor.GRASS).notSolid().doesNotBlockMovement().sound(SoundType.SLIME)));
}
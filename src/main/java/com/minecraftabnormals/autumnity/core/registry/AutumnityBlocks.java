...
public class AutumnityBlocks {
	...
	public static final RegistryObject<Block> CURSED_JACK_O_LANTERN = HELPER.createCompatBlock("caverns_and_chasms", "cursed_jack_o_lantern", () -> new AutumnityJackOLanternBlock(Block.Properties.from(Blocks.PUMPKIN).setLightLevel(AutumnityProperties.getMaxLightValue())), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> LARGE_CURSED_JACK_O_LANTERN_SLICE = HELPER.createCompatBlock("caverns_and_chasms", "large_cursed_jack_o_lantern_slice", () -> new CarvedLargePumpkinSliceBlock(Block.Properties.from(Blocks.PUMPKIN).setLightLevel(AutumnityProperties.getMaxLightValue())), ItemGroup.BUILDING_BLOCKS);

...
public class AutumnityItems
{
    ...
    public static final RegistryObject<Item> SWIRL_BANNNER_PATTERN = HELPER.createItem("swirl_banner_pattern", () -> new AbnormalsBannerPatternItem(AutumnityBanners.SWIRL, new Item.Properties().group(ItemGroup.MISC).maxStackSize(1)));

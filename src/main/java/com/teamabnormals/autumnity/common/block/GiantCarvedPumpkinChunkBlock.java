...
public class GiantCarvedPumpkinChunkBlock extends GiantJackOLanternChunkBlock {
	public GiantCarvedPumpkinChunkBlock(Properties properties) {
		super(properties);
	}
	...
	public ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
		...
		if (jackolantern instanceof GiantJackOLanternChunkBlock) {

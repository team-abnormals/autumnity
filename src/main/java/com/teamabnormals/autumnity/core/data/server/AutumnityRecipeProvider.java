...
public class AutumnityRecipeProvider extends BlueprintRecipeProvider {
	...
	public void buildRecipes(RecipeOutput output) {
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, GIANT_PUMPKIN_CHUNK.get(), 4).define('#', Blocks.PUMPKIN).pattern("##").pattern("##").unlockedBy("has_pumpkin", has(Blocks.PUMPKIN)).save(output);
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, GIANT_JACK_O_LANTERN_CHUNK.get()).define('A', GIANT_CARVED_PUMPKIN_CHUNK.get()).define('B', Blocks.TORCH).pattern("A").pattern("B").unlockedBy("has_carved_large_pumpkin_slice", has(GIANT_CARVED_PUMPKIN_CHUNK.get())).save(output);
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, GIANT_REDSTONE_JACK_O_LANTERN_CHUNK.get()).define('A', GIANT_CARVED_PUMPKIN_CHUNK.get()).define('B', Blocks.REDSTONE_TORCH).pattern("A").pattern("B").unlockedBy("has_carved_large_pumpkin_slice", has(GIANT_CARVED_PUMPKIN_CHUNK.get())).save(output);
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, GIANT_SOUL_JACK_O_LANTERN_CHUNK.get()).define('A', GIANT_CARVED_PUMPKIN_CHUNK.get()).define('B', Blocks.SOUL_TORCH).pattern("A").pattern("B").unlockedBy("has_carved_large_pumpkin_slice", has(GIANT_CARVED_PUMPKIN_CHUNK.get())).save(output);
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, GIANT_ENDER_JACK_O_LANTERN_CHUNK.get()).define('A', GIANT_CARVED_PUMPKIN_CHUNK.get()).define('B', AutumnityItemTags.TORCHES_ENDER).pattern("A").pattern("B").unlockedBy("has_carved_large_pumpkin_slice", has(GIANT_CARVED_PUMPKIN_CHUNK.get())).save(output.withConditions(ENDERGETIC_LOADED));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, GIANT_CUPRIC_JACK_O_LANTERN_CHUNK.get()).define('A', GIANT_CARVED_PUMPKIN_CHUNK.get()).define('B', AutumnityItemTags.TORCHES_CUPRIC).pattern("A").pattern("B").unlockedBy("has_carved_large_pumpkin_slice", has(GIANT_CARVED_PUMPKIN_CHUNK.get())).save(output.withConditions(CAVERNS_AND_CHASMS_LOADED));

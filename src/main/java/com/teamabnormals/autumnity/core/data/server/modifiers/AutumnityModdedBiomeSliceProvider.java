...
public class AutumnityModdedBiomeSliceProvider extends ModdedBiomeSliceProvider {
	...
	private static final class AutumnBiomeBuilder {
		...
		private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {AutumnityBiomes.PUMPKIN_FIELDS.getKey(), AutumnityBiomes.PUMPKIN_FIELDS.getKey(), AutumnityBiomes.MAPLE_FOREST.getKey(), VANILLA, VANILLA}, {VANILLA, AutumnityBiomes.PUMPKIN_FIELDS.getKey(), VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
		private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = new ResourceKey[][]{{VANILLA, null, VANILLA, null, null}, {AutumnityBiomes.MAPLE_FOREST.getKey(), null, null, null, VANILLA}, {VANILLA, AutumnityBiomes.MAPLE_FOREST.getKey(), null, VANILLA, null}, {null, null, VANILLA, VANILLA, VANILLA}, {null, null, null, null, null}};
		private final ResourceKey<Biome>[][] PLATEAU_BIOMES = new ResourceKey[][]{{VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, AutumnityBiomes.MAPLE_FOREST.getKey(), VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
		private final ResourceKey<Biome>[][] PLATEAU_BIOMES_VARIANT = new ResourceKey[][]{{VANILLA, null, null, null, null}, {null, null, VANILLA, VANILLA, VANILLA}, {null, null, AutumnityBiomes.MAPLE_FOREST.getKey(), VANILLA, null}, {null, null, null, null, null}, {VANILLA, VANILLA, null, null, null}};

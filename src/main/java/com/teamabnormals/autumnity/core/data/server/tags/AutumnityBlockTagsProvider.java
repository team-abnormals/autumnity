...
public class AutumnityBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.GUARDED_BY_PIGLINS).add(MAPLE_CHEST.get(), MAPLE_TRAPPED_CHEST.get());
		...
		this.tag(BlockTags.MINEABLE_WITH_AXE).add(FOUL_BERRY_BUSH.get(), TALL_FOUL_BERRY_BUSH.get(), MAPLE_BOARDS.get(), MAPLE_BOOKSHELF.get(), MAPLE_LADDER.get(), MAPLE_BEEHIVE.get(), MAPLE_CHEST.get(), MAPLE_TRAPPED_CHEST.get(), SOUL_JACK_O_LANTERN.get(), REDSTONE_JACK_O_LANTERN.get(), ENDER_JACK_O_LANTERN.get(), CUPRIC_JACK_O_LANTERN.get(), LARGE_PUMPKIN_SLICE.get(), CARVED_LARGE_PUMPKIN_SLICE.get(), LARGE_JACK_O_LANTERN_SLICE.get(), LARGE_SOUL_JACK_O_LANTERN_SLICE.get(), LARGE_REDSTONE_JACK_O_LANTERN_SLICE.get(), LARGE_ENDER_JACK_O_LANTERN_SLICE.get(), LARGE_CUPRIC_JACK_O_LANTERN_SLICE.get(), FOUL_BERRY_BASKET.get(), TURKEY_EGG_CRATE.get());
		...
		this.tag(Tags.Blocks.CHESTS_WOODEN).add(MAPLE_CHEST.get(), MAPLE_TRAPPED_CHEST.get());
		this.tag(Tags.Blocks.CHESTS_TRAPPED).add(MAPLE_TRAPPED_CHEST.get());

...
public class AutumnityBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.MINEABLE_WITH_HOE).add(MAPLE_LEAVES.get(), YELLOW_MAPLE_LEAVES.get(), ORANGE_MAPLE_LEAVES.get(), RED_MAPLE_LEAVES.get(), MAPLE_LEAF_PILE.get(), YELLOW_MAPLE_LEAF_PILE.get(), ORANGE_MAPLE_LEAF_PILE.get(), RED_MAPLE_LEAF_PILE.get(), MAPLE_LEAF_CARPET.get(), YELLOW_MAPLE_LEAF_CARPET.get(), ORANGE_MAPLE_LEAF_CARPET.get(), RED_MAPLE_LEAF_CARPET.get());

...
public class AutumnityBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.FLOWER_POTS).add(POTTED_AUTUMN_CROCUS.get(), POTTED_FOUL_BERRIES.get(), POTTED_MAPLE_SAPLING.get(), YELLOW_MAPLE_SAPLING.get(), ORANGE_MAPLE_SAPLING.get(), RED_MAPLE_SAPLING.get());

...
public class AutumnityBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.ENDERMAN_HOLDABLE).add(GIANT_PUMPKIN_CHUNK.get(), GIANT_CARVED_PUMPKIN_CHUNK.get());
		this.tag(BlockTags.PIGLIN_REPELLENTS).add(SOUL_JACK_O_LANTERN.get(), GIANT_SOUL_JACK_O_LANTERN_CHUNK.get());
		...
		this.tag(BlockTags.MINEABLE_WITH_AXE).add(FOUL_BERRY_BUSH.get(), TALL_FOUL_BERRY_BUSH.get(), SOUL_JACK_O_LANTERN.get(), REDSTONE_JACK_O_LANTERN.get(), ENDER_JACK_O_LANTERN.get(), CUPRIC_JACK_O_LANTERN.get(), GIANT_PUMPKIN_CHUNK.get(), GIANT_CARVED_PUMPKIN_CHUNK.get(), GIANT_JACK_O_LANTERN_CHUNK.get(), GIANT_SOUL_JACK_O_LANTERN_CHUNK.get(), GIANT_REDSTONE_JACK_O_LANTERN_CHUNK.get(), GIANT_ENDER_JACK_O_LANTERN_CHUNK.get(), GIANT_CUPRIC_JACK_O_LANTERN_CHUNK.get(), FOUL_BERRY_BASKET.get(), TURKEY_EGG_CRATE.get());

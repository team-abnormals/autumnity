...
public class AutumnityFeatures {
	...
	public static final class AutumnityConfiguredFeatures {
		...
		public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
			...
			register(context, EARLY_MAPLE_FOREST_TREES, AutumnityFeatures.NOISE_SELECTOR.get(), new NoiseSelectorFeatureConfiguration(noise.get(AutumnityNoiseParameters.MAPLE_GRADIENT).get(), List.of(new NoiseThresholdPlacedFeature(placedFeatures.getOrThrow(AutumnityPlacedFeatures.RED_MAPLE_TREE_FALLEN_LEAVES_BEES_0002), -0.9F), new NoiseThresholdPlacedFeature(placedFeatures.getOrThrow(AutumnityPlacedFeatures.ORANGE_MAPLE_TREE_FALLEN_LEAVES_BEES_0002), -0.1F), new NoiseThresholdPlacedFeature(placedFeatures.getOrThrow(AutumnityPlacedFeatures.YELLOW_MAPLE_TREE_FALLEN_LEAVES_BEES_0002), 0.25F)), placedFeatures.getOrThrow(AutumnityPlacedFeatures.MAPLE_TREE_BEES_0002)));
			...
			register(context, LATE_MAPLE_FOREST_TREES, AutumnityFeatures.NOISE_SELECTOR.get(), new NoiseSelectorFeatureConfiguration(noise.get(AutumnityNoiseParameters.MAPLE_GRADIENT).get(), List.of(new NoiseThresholdPlacedFeature(placedFeatures.getOrThrow(AutumnityPlacedFeatures.RED_MAPLE_TREE_FALLEN_LEAVES_BEES_0002), 0.2F), new NoiseThresholdPlacedFeature(placedFeatures.getOrThrow(AutumnityPlacedFeatures.ORANGE_MAPLE_TREE_FALLEN_LEAVES_BEES_0002), 0.7F), new NoiseThresholdPlacedFeature(placedFeatures.getOrThrow(AutumnityPlacedFeatures.YELLOW_MAPLE_TREE_FALLEN_LEAVES_BEES_0002), 0.9F)), placedFeatures.getOrThrow(AutumnityPlacedFeatures.MAPLE_TREE_BEES_0002)));
			register(context, MAPLE_FOREST_TREES, AutumnityFeatures.NOISE_SELECTOR.get(), new NoiseSelectorFeatureConfiguration(noise.get(AutumnityNoiseParameters.AUTUMN_PROGRESS).get(), List.of(new NoiseThresholdPlacedFeature(placedFeatures.getOrThrow(AutumnityPlacedFeatures.EARLY_MAPLE_FOREST_TREES), -0.4F), new NoiseThresholdPlacedFeature((placedFeatures.getOrThrow(AutumnityPlacedFeatures.MIDDLE_MAPLE_FOREST_TREES)), 0.4F)), placedFeatures.getOrThrow(AutumnityPlacedFeatures.LATE_MAPLE_FOREST_TREES)));
			...
			register(context, FALLEN_MAPLE_LEAVES_RED, AutumnityFeatures.FALLEN_MAPLE_LEAVES.get(), redMaple().build());
			...
			register(context, MAPLE_FOREST_FALLEN_LEAVES, AutumnityFeatures.NOISE_SELECTOR.get(), new NoiseSelectorFeatureConfiguration(noise.get(AutumnityNoiseParameters.AUTUMN_PROGRESS).get(), List.of(new NoiseThresholdPlacedFeature(placedFeatures.getOrThrow(AutumnityPlacedFeatures.EARLY_MAPLE_FOREST_FALLEN_LEAVES), -0.4F), new NoiseThresholdPlacedFeature((placedFeatures.getOrThrow(AutumnityPlacedFeatures.MIDDLE_MAPLE_FOREST_FALLEN_LEAVES)), 0.4F)), placedFeatures.getOrThrow(AutumnityPlacedFeatures.LATE_MAPLE_FOREST_FALLEN_LEAVES)));
	...
	public static final class AutumnityPlacedFeatures {
		...
		public static final ResourceKey<PlacedFeature> EARLY_MAPLE_FOREST_TREES = createKey("early_maple_forest");
		public static final ResourceKey<PlacedFeature> MIDDLE_MAPLE_FOREST_TREES = createKey("trees_maple_forest");
		public static final ResourceKey<PlacedFeature> LATE_MAPLE_FOREST_TREES = createKey("late_maple_forest");

...
public class AutumnityItems {
	...
	public static final RegistryObject<Item> FOUL_BERRIES = HELPER.createItem("foul_berries", ModList.get().isLoaded("berry_good") ? () -> new Item((new Item.Properties()).tab(CreativeModeTab.TAB_FOOD).food(AutumnityFoods.FOUL_BERRIES)) : () -> new ItemNameBlockItem(AutumnityBlocks.FOUL_BERRY_BUSH.get(), (new Item.Properties()).tab(CreativeModeTab.TAB_FOOD).food(AutumnityFoods.FOUL_BERRIES)));
	public static final RegistryObject<Item> FOUL_BERRY_PIPS = HELPER.createItem("foul_berry_pips", ModList.get().isLoaded("berry_good") ? () -> new ItemNameBlockItem(AutumnityBlocks.FOUL_BERRY_BUSH.get(), (new Item.Properties()).tab(CreativeModeTab.TAB_MISC)) : () -> new Item(new Item.Properties()));
